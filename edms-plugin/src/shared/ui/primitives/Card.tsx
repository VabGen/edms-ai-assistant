...
export const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, isSelected, isClickable, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "bg-white border border-zinc-100/80 rounded-[20px] transition-all duration-200 ease-out shadow-sm overflow-hidden",
        isClickable && "cursor-pointer hover:shadow-md hover:border-zinc-200 active:scale-[0.98]",
