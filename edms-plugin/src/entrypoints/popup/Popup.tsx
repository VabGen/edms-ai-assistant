/**
 * @file Popup.tsx
 * @description Chrome Extension popup — toggle EDMS Assistant on/off.
 */
...
export function Popup() {
    ...
    const handleToggleKey = (e: KeyboardEvent<HTMLDivElement>) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Ripple on toggle — keyframes live in globals.css (fix #9) */}
                {ripple && (
                    <div style={{
                        position: 'absolute',
                        top: '50%', right: 28,
                ...
                <div style={{padding: '14px 16px 13px'}}>
                    ...
                    <div style={{display: 'flex', alignItems: 'center', gap: 10}}>
                        ...
                        {/* Fix #11: iOS-style toggle with keyboard support */}
                        <div
                            onClick={toggle}
                            ...
                            aria-label="Включить или выключить EDMS Assistant"
                            style={{
                                position: 'relative',
                                width: 48,
                                height: 28,
              ...
              `}</style>
                    ...
                    {/* Divider */}
                    <div
                        style={{height: 1, background: 'rgba(0,0,0,0.06)', margin: '12px -16px', marginLeft: '-16px'}}/>
            ...
            {/* No inline @keyframes here — ios-ripple lives in globals.css (fix #9) */}
        </div>
    )
}