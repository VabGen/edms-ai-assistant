...
def get_nlp_service(
    ...
    return EDMSNaturalLanguageService(entity_extractor=entity_extractor, query_refiner=query_refiner)
...
def get_introduction_service(
    ...
    return IntroductionService(resolution_service=resolution_service, transport=transport)
...
def get_appeal_autofill_service(
        ...
        extraction_service: Annotated[AppealExtractionService, Depends(get_appeal_extraction_service)],
        llm: Annotated[Any, Depends(get_chat_model)],
...
AppealExtSer = Annotated[AppealExtractionService, Depends(get_appeal_extraction_service)]
