...
def get_chat_model() -> BaseLanguageModel:
    ...
    logger.info(f"Инициализация ChatModel: {settings.LLM_ENDPOINT}, модель: {settings.LLM_MODEL_NAME}")
...
def get_embedding_model() -> Embeddings:
    ...
    logger.info(f"Инициализация EmbeddingModel: {settings.EMBEDDING_ENDPOINT}, модель: {settings.EMBEDDING_MODEL_NAME}")
...
def get_embedding_model_custom() -> Embeddings:
    ...
    logger.info(f"Инициализация кастомной EmbeddingModel: {settings.EMBEDDING_ENDPOINT}")
