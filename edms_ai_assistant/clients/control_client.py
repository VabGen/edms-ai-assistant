...
class ControlClient(EdmsBaseClient):
    ...
    async def get_control_types(
        ...
        result = await self.make_request(
            "GET", "api/control-type", token=token, params=params
        )
    ...
    async def get_control_type(
        self, token: str, control_type_id: UUID
    ) -> ControlTypeDto:
    ...
    async def create_control_type(
        self, token: str, request: ControlTypeRequest
    ) -> ControlTypeDto:
    ...
    async def set_control(
        self, token: str, document_id: UUID | str, payload: dict[str, Any]
    ) -> ControlDto:
